...
folder_1 = 'Households/'
folder_2 = 'Cooking/'
path = 'Demand_Expected.xls'
writer = ExcelWriter(path, engine='xlsxwriter')
path_demand = 'Demand.xls'
writer_demand = ExcelWriter(path_demand, engine='xlsxwriter')
...
for i in Village_Population:
    ...
    instance1.to_excel(writer_demand, sheet_name=sheet_name)
